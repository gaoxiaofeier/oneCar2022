    ...
    <div class="user-manage" v-if="showToogle">
          ...
          <el-row>
            ...
            <el-col :span="5">
              <el-form-item label="昵称：">
                <el-input v-model="search.petName"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="10">
      ...
      <div class="table-wrap">
        <el-table :data="tableData" border style="width: 100%" @sort-change="handleSortChange">
          ...
          <el-table-column prop="vip2" label="vip状态">
          </el-table-column>
          ...
          <el-table-column prop="lastLogin" label="最近登录时间" width="100px">
            <template slot-scope="scope">
